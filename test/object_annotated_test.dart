...
void main() {
  ...
  group('Test complex serializer', () {
    ...
    test(
        'GIVEN two instances created with constructor methods WHEN comparing them THEN are equal',
            () {
          /// GIVEN
          ObjectLib().prepareInstances(
            [
          ...
          final sampleA = AnnotationComplexSample().constructor(
            id: '',
            numberContent: 0,
            integerContent: 0,
            doubleContent: 0.0,
          ...
          final sampleB = AnnotationComplexSample().constructorWith();

          expect(sampleA.toReadableJson(), sampleB.toReadableJson());
        });
  });
}
